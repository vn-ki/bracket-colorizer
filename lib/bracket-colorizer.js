...
export default {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.config.onDidChange('bracket-colorizer.alternate_different', (value) => {
      this.alternate_different = value;
      this.cleanAll();
      this.processEditor();
    }));
  ...
  processEditor() {
    ...
    const editorObj = {
      ...
      bracketMatcher: new BracketMatcher(editor, this.brackets, this.repeat_color, this.alternate_different),
    };
